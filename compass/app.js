...
function renderHealth() {
  const rows = [
    {k:"Sleep", v:"Not yet connected"},
    {k:"Movement", v:"Not yet connected"},
    {k:"Food", v:"Not yet connected"},
    {k:"Stress", v:S.confidence.score < 50 ? "Elevated" : "Moderate"},
    {k:"Recovery", v:"Not yet connected"},
    {k:"Hormones", v:"Not yet connected"},
    {k:"Hydration", v:"Not yet connected"},
    {k:"Energy", v:S.mood.today || "Unknown"},
  ];
  return `
    ${backButton('areas')}
    <h1>Health</h1>
    <p>Connect Apple Health &amp; Body Atelier to populate these automatically.</p>
...
function renderHouseArea() {
  ...
  return `
    ...
    ${listCard(items)}
    <p class="subtle">Links into House of Harriet once connected.</p>
  `;
}
